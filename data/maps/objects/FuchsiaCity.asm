...
FuchsiaCity_Object:
	...
	object_event 31,  5, SPRITE_CHAN, WALK, ANY_DIR, TEXT_FUCHSIACITY_CHANSEY
	object_event 25,  6, SPRITE_VOLTORB, STAY, NONE, TEXT_FUCHSIACITY_VOLTORB
	object_event 12,  6, SPRITE_KAN, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_KANGASKHAN
	object_event 30, 12, SPRITE_SLOW, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_SLOWPOKE
	object_event  8, 17, SPRITE_LAP, WALK, ANY_DIR, TEXT_FUCHSIACITY_LAPRAS
	object_event  6,  5, SPRITE_FOSSIL, STAY, NONE, TEXT_FUCHSIACITY_FOSSIL
	object_event  5,  5, SPRITE_FOSSIL, STAY, NONE, TEXT_FUCHSIACITY_FOSSIL2
