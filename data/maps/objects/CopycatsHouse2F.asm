...
CopycatsHouse2F_Object:
	...
	object_event  4,  6, SPRITE_DUO, WALK, LEFT_RIGHT, TEXT_COPYCATSHOUSE2F_DODUO
	object_event  5,  1, SPRITE_JIGGDOLL, STAY, DOWN, TEXT_COPYCATSHOUSE2F_MONSTER
	object_event  2,  0, SPRITE_SPE, STAY, LEFT, TEXT_COPYCATSHOUSE2F_BIRD
	object_event  1,  6, SPRITE_PIKADOLL, STAY, RIGHT, TEXT_COPYCATSHOUSE2F_FAIRY
