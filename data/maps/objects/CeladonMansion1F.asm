...
CeladonMansion1F_Object:
	...
	def_object_events
	object_event  0,  5, SPRITE_MEO, STAY, ANY_DIR, TEXT_CELADONMANSION1F_MEOWTH
	object_event  1,  5, SPRITE_GRANNY, STAY, DOWN, TEXT_CELADONMANSION1F_GRANNY
	object_event  1,  8, SPRITE_CLE, WALK, LEFT_RIGHT, TEXT_CELADONMANSION1F_CLEFAIRY
	object_event  4,  4, SPRITE_NIDOF, WALK, UP_DOWN, TEXT_CELADONMANSION1F_NIDORANF
